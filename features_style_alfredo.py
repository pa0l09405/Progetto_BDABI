...
if __name__=='__main__':
    ...
    colname = df_spark.toPandas().columns[indici]
    print (colname)
    ...
    ExtractFeatureImp(model.featureImportances, train, "features").head(best_idx)
    ...
    print("[Decision Tree] Tutti i parametri ", params)
    print("CIAOOOOO", cvModel.bestModel.extractParamMap().items())
